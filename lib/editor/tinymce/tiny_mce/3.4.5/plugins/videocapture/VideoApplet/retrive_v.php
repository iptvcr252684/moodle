<?php
 /*
  * This script will copy the temporary video clip that was recorded by the Video Recorder Java applet
  * into a temoprary folder : moodledata/videocapture under a unique filename with a date
  *
