...
function insertMedia() {
    ajaxRequest.open("GET", "move_tempfile_to_storage.php?videofile=" + tempvideofile + "&videofolder=" + tempvideofolder, true);
    ajaxRequest.send();
...
function generatePreview(c) {
    ...
    pl = tinyMCEPopup.editor.plugins.videocapture._parse(pl);
    ...
    pl.id = !pl.id ? 'videocapture' : pl.id;
    pl.name = !pl.name ? 'videocapture' : pl.name;
