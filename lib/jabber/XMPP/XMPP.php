...
class XMPPHP_XMPP extends XMPPHP_XMLStream {
	...
	public function __construct($host, $port, $user, $password, $resource, $server = null, $printlog = false, $loglevel = null) {
        ...
        // not sure what $this->user is holding (ex. $this->user = 'someuser@gmail.com' ???)
        // in that case, we need to split off the host/server...
        //list($juserid,$juserhost) = explode('@',$this->user);
        //$this->basejid = $juserid . '@' . $this->server;
